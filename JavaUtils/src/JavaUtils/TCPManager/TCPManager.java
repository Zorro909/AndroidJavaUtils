...
public class TCPManager {
	 ...
	 * @throws IOException
	 */
	public static TcpServer startServer(int port, boolean lookForClientsAutomatically, TcpServerListener listener)
			throws IOException {
		server = true;
	 ...
	 */
	public static TcpServer startServer(int port, boolean lookForClientsAutomatically, TcpServerListener listener,
			TcpServerMode mode) throws KeyStoreException, NoSuchAlgorithmException, CertificateException,
	 ...
	 */
	public static void lookForClientsAutomatically(final TcpServer tcpServer, final TcpServerListener listener) {
	 ...
	 *            (Recommended)
	 * @param listener
	 *            An TcpClientListener [Only Needed if {@code automaticListen}
	 *            is true]
	 ...
	 * @throws KeyManagementException
	 */
	public static TcpConnection connect(String url, int port, boolean automaticListen, TcpClientListener listener,
			TcpConnectionMode mode) throws UnknownHostException, IOException, NoSuchAlgorithmException,
	...
	public static XmlTcpConnection connectXml(String string, Integer valueOf, boolean b, TcpClientListener listener)
			throws UnknownHostException, IOException {
